          ...
          <div className="flex flex-col gap-4 justify-center items-center">
            ...
            <div className="p-3 bg-[#a3ff12]/5 rounded-lg border border-[#a3ff12]/20">
              <p className="text-sm text-white/60">
                💡 <span className="font-semibold text-white/80">Tip:</span> Paste this code in the <code className="text-[#a3ff12] bg-black/30 px-1.5 py-0.5 rounded">&lt;head&gt;</code> section of your HTML to optimize your website for search engines across all languages.
              </p>
            </div>
          </div>
        </div>
